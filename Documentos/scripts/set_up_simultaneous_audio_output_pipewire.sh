...
if [ ! -h "/etc/wireplumber/main.lua.d/51-alsa-disable.lua" ];then
    ...
    /usr/bin/pactl load-module module-combine-sink sink_name=combination-sink sink_properties=slaves=alsa_output.pci-0000_01_00.1.hdmi-stereo-extra3,alsa_output.pci-0000_00_1f.3.analog-stereo channels=2
    /usr/bin/sleep 1
