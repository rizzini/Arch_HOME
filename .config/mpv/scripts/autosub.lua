...
--          { '--legendastv', 'USERNAME', 'PASSWORD' },
            { '--opensubtitles', 'rizzinibr', '1q2w3e4rAZ[][]' },
...
local includes = {
    ...
    -- Full paths are also allowed, e.g.:
       '/mnt/hdd/Downloads_HDD','/mnt/hdd/Videos', '/home/lucas/Videos'
}
--=============================================================================
...
mp.add_key_binding('m', 'download_subs', download_subs)
mp.add_key_binding('k', 'download_subs2', download_subs2)
