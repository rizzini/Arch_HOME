...
KCM.SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        QtControls.Label {
            text: i18n("Symbols: https://coolsymbol.com/")
        }
        ...
        QtLayouts.RowLayout {
            ...
            QtControls.Button {
                text: 'Reset'
                onClicked: command.text = 'qdbus6 org.kde.kglobalaccel /component/kwin invokeShortcut Overview'
            }
        }
        ...
        QtLayouts.RowLayout {
            ...
            QtControls.TextField {
                ...
                text: i18n("qdbus6 org.kde.kglobalaccel /component/kwin invokeShortcut Overview")
